...
namespace TimDongDoi.API.DTOs.Job
{
    ...
    public class CreateJobRequest
    {
        ...
        public string Level { get; set; } = "junior"; // intern, junior, mid, senior, lead
        ...
        public string LocationType { get; set; } = "onsite"; // onsite, remote, hybrid
        ...
        // Skills required
        public List<AddJobSkillRequest>? Skills { get; set; }
    }
}